[![Build Status](https://git.vauxoo.com/vauxoo/spc/badges/13.0/pipeline.svg)](https://git.vauxoo.com/vauxoo/spc/pipelines)
[![Coverage Report](https://git.vauxoo.com/vauxoo/spc/badges/13.0/coverage.svg)](https://coverage.vauxoo.com/13-0-spc)
[![Runbot Status](http://runbot.vauxoo.com/runbot/badge/210/13.0.svg)](https://runbot.vauxoo.com/runbot/repo/git-git-vauxoo-com-vauxoo-spc-git-210)
...
1. Install travis2docker in order to a create local environment (docker
   container) copy of last changes on the spc repository:
    ...
    of spc for make functional tests or even for do new developments:
...
5. After the last script is finish you will notice that your prompt has change,
   ...
   like this:
    ...
    spc:
        ...
        - main repository will be ALWAYS inside /root/build/vauxoo/spc
